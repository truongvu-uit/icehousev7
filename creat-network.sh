...
sleep 3
neutron subnet-create --name sub_ext_net ext_net 192.168.32.0/24 --gateway 192.168.32.1 --allocation-pool start=192.168.32.200,end=192.168.32.250 --enable_dhcp=False --dns-nameservers list=true 8.8.8.8 8.8.4.4 210.245.0.11
